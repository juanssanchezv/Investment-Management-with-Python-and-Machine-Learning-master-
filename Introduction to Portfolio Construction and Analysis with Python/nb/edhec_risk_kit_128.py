...
def get_ffme_returns():
    ...
    """
    me_m = pd.read_csv("/Coursera/Investment Management with Python and Machine Learning/Introduction to Portfolio Construction and Analysis with Python/data/Portfolios_Formed_on_ME_monthly_EW.csv",
...
def get_hfi_returns():
    ...
    """
    hfi = pd.read_csv("/Coursera/Investment Management with Python and Machine Learning/Introduction to Portfolio Construction and Analysis with Python/data/edhec-hedgefundindices.csv",
...
def get_ind_file(filetype):
    ...
    if filetype is "returns":
        ...
        name = "size"
        divisor = 1
    ind = pd.read_csv(f"/Coursera/Investment Management with Python and Machine Learning/Introduction to Portfolio Construction and Analysis with Python/data/ind30_m_{name}.csv", header=0, index_col=0)/divisor
